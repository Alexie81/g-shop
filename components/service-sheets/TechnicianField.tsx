      ...
      <ModalSafeBottom style={[styles.overlay, { backgroundColor: colors.overlay }]}>
        ...
        <KeyboardAvoidingView style={styles.positioner} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
          <View style={[styles.sheet, { backgroundColor: colors.surfaceElevated, borderColor: colors.border }]}>
            ...
            {adding ? <ScrollView keyboardShouldPersistTaps="handled" contentContainerStyle={styles.form}>
...
const styles = StyleSheet.create({
  ...
  overlay: { justifyContent: 'flex-end' }, positioner: { maxHeight: '92%', justifyContent: 'flex-end' }, sheet: { width: '100%', maxWidth: 680, maxHeight: '90%', alignSelf: 'center', borderWidth: 1, borderTopLeftRadius: 30, borderTopRightRadius: 30, padding: spacing.lg, gap: spacing.lg, shadowColor: '#000', shadowOffset: { width: 0, height: -12 }, shadowOpacity: 0.22, shadowRadius: 30, elevation: 18 }, handle: { width: 48, height: 5, borderRadius: 3, alignSelf: 'center' }, header: { flexDirection: 'row', alignItems: 'center', gap: spacing.md }, headerIcon: { width: 50, height: 50, borderRadius: 17, alignItems: 'center', justifyContent: 'center' }, headerCopy: { minWidth: 0, flex: 1, gap: 2 }, close: { width: 44, height: 44, borderRadius: 15, alignItems: 'center', justifyContent: 'center' }, help: { borderWidth: 1, borderRadius: radius.md, padding: spacing.md, flexDirection: 'row', alignItems: 'center', gap: spacing.sm }, helpCopy: { minWidth: 0, flex: 1 }, list: { maxHeight: 410 }, listContent: { gap: spacing.sm }, item: { minHeight: 68, padding: spacing.md, borderWidth: 1, borderRadius: radius.md, flexDirection: 'row', alignItems: 'center', gap: spacing.md }, avatar: { width: 42, height: 42, borderRadius: 14, alignItems: 'center', justifyContent: 'center' }, itemCopy: { minWidth: 0, flex: 1, gap: 2 }, empty: { minHeight: 210, alignItems: 'center', justifyContent: 'center', gap: spacing.sm, padding: spacing.xl }, emptyIcon: { width: 58, height: 58, borderRadius: 20, alignItems: 'center', justifyContent: 'center' }, emptyText: { textAlign: 'center', maxWidth: 340 }, form: { gap: spacing.lg }, row: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.md }, flex: { minWidth: 190, flex: 1 }, flexWide: { minWidth: 230, flex: 1.4 }, multiline: { minHeight: 74, textAlignVertical: 'top' }, actions: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.md },
});
