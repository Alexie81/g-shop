      ...
      <ModalSafeBottom style={[styles.modalOverlay, { backgroundColor: colors.overlay }]}>
        ...
        <View style={[styles.logoutModal, { backgroundColor: colors.surfaceElevated, borderColor: colors.border }]}>
          ...
          <View style={[styles.modalActions, compact && styles.modalActionsCompact]}>
            <Button variant="outline" label="Rămân conectat" disabled={logoutLoading} onPress={() => setLogoutOpen(false)} style={[styles.modalButton, compact && styles.modalButtonCompact]} />
            <Button variant="danger" label="Deconectare" icon="log-out-outline" loading={logoutLoading} onPress={() => void confirmLogout()} style={[styles.modalButton, compact && styles.modalButtonCompact]} />
          </View>
        </View>
      </ModalSafeBottom>
    </Modal>
